...
const codeUsageExtensionDirectory = join(repositoryRoot, "packages/extensions/code-usage");
const memoryExtensionDirectory = join(repositoryRoot, "packages/extensions/memory");
