...
Divebell walkthrough, agent instructions, or debugging answers. Runtime SDK
and the controlled analysis scenarios remain available behind the
...
- Inventory creates a real 404, records a matching Console error, exposes the
  blocked workflow through Runtime SDK, and declares a safe retry action.
