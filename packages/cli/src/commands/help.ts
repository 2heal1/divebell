...
export const cliCommandReferences: CliCommandReference[] = [
  ...
  {
    category: "Bridge and Browser",
    usage: "divebell open <url> [--timeout <ms>] [--headers <json>] [--profile <name|path> | --state <path>] [--no-default-profile] [--no-default-state] [--restore-save <auto|always|never>] [--restore-initial-save <bool>] [--restore-periodic-save [bool]] [--restore-close-save <bool>] [--restore-periodic-save-interval-ms <ms>] [--bridge <url>] [--port <port>] [--session <id>] [--no-bridge] [--ui] [--no-webmcp] [--enable <feature>] [--init-script <path>] [--proxy <url> | --proxy-pac-url <url>] [--request-rules <path>] [--remove-response-header <name>] [--allowed-domains <list>] [--engine <name>]",
