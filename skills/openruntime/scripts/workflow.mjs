      ...
      parsed: {
        result: {
          ...
          evidence: {
            ...
            nextStep: "Install @openruntime/cli, run `openruntime extensions add @openruntime/extension-troubleshooting`, connect the page runtime, then rerun workflow verify."
          }
        }
      }
    };
